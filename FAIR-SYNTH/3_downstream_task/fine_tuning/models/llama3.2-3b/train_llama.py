...
def main():
    parser = argparse.ArgumentParser(description="Llama-3.2-3B QLoRA Fine-tuning")
    parser.add_argument("--data_path", type=str, required=True,
                       help="Path to training data (JSONL format)")
    parser.add_argument("--output_dir", type=str, 
                       default="checkpoints/llama3.2-3b",
    ...
    try:
        trainer.train()
        console.print(f"[bold green]Llama-3.2-3B fine-tuning completed![/bold green]")
